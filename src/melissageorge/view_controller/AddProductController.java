...
public class AddProductController {
    ...
    private ObservableList<Part> relatedPartArray = FXCollections.observableArrayList();
    ...
    void AddButtonHandler(ActionEvent event) {
        ...
        if(!(relatedPartArray.contains(part))) {
            relatedPartArray.add(part);
            relatedParts.setItems(relatedPartArray);
        }
    }
    ...
    void saveButtonHandler(ActionEvent event) throws IOException {
        if(isInputValid()) {
            ...
            product.setAssociatedParts(relatedPartArray);
    ...
    void searchButtonHandler(ActionEvent event) {
        String searchItem=searchFieldText.getText();
        boolean found=false;
